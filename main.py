...
class ValidateUserMixin:
    @staticmethod
    def _name_in_data(name: str, data: List[dict]):
        return any(dict_['name'].lower() == name.lower() for dict_ in data)

    @staticmethod
    def _true_password(name: str, password: str, file: List[dict]):
...
sam = User()
print(sam.register('John1', 'qwerty123'))
# print(sam.login('John1', 'qwerty123'))
# print(sam.change_password('John', 'qwerty12', 'qwerty123'))
# print(sam.change_name('John', 'Snow'))